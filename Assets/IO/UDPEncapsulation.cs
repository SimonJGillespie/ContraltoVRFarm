...
{    
    ...
    public class UDPEncapsulation : IPacketEncapsulation
    {
        ...
        public virtual void Send(ushort[] packet, int length)
        {
        ...
        public virtual void ReceiveThread()
        {
