...
namespace Contralto
{
    ...
    public class Configuration
    {
        ...
        public static string GetAltoIRomPath(string romFileName)
        {
            ...
            {
                return Path.Combine(RomPath, "AltoI", romFileName);
            }
        }
        ...
        public static string GetAltoIIRomPath(string romFileName)
        {
            ...
            {
                return Path.Combine(RomPath, "AltoII", romFileName);
            }
        }
        ...
        public static string GetRomPath(string romFileName)
        {
            ...
            {
                return Path.Combine(RomPath, romFileName);
            }
        }       
        ...
        public static string ConfigurationFile ="Contralto.cfg";
