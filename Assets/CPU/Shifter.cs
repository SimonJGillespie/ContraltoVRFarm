...
namespace Contralto.CPU
{
    ...
    public  class Shifterc
    {
        ...
        public  void SetOperation(ShifterOp op)
        {
            _op = op;            
        }

        public  void SetModifier(ShifterModifier mod)
        {
            _modifier = mod;
        }        
        ...
        public  ushort DoOperation(ushort input, ushort t)
        {           
            switch(_op)
            {               
                case ShifterOp.None:
        ...
        private  ShifterOp _op;
        private  ushort _output;        
        private  ShifterModifier _modifier;
        private  int _dnsCarry;
    }
}
