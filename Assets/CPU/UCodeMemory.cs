...
namespace Contralto.CPU
{
     ...
     public class UCodeMemoryc
    {
        ...
        private  UInt32 MapWord(UInt32 word)
        {
        ...
        private  UInt32 MapRAMWord(UInt32 word)
        {
            // Invert the requisite bits just to make things easier; the high bits of F1 and F2 and the Load L bit are inverted
            // already; we leave those alone.
        ...
        private  int AddressMapAltoII(int address)
        {            
            int  mappedAddress = (~address) & 0x3ff;
            return mappedAddress;
        }

        private  int AddressMapAltoI(int address)
        {
        ...
        private  RomFile[] _uCodeRomsAltoI =
        {
            // 0 to 377
        ...
        private  RomFile[] _uCodeRomsAltoII =
       {
