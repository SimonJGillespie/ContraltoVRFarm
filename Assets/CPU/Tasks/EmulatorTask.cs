            ...
            protected override void ExecuteSpecialFunction2(MicroInstruction instruction)
            {
                ...
                switch (ef2)
                {
                    ...
                    case EmulatorF2.MAGIC:
                        _cpu.Shifter.SetModifier(ShifterModifier.Magic);
                        break;
                    ...
                    case EmulatorF2.LoadDNS:
                        ...
                        // given carry bit.
                        _cpu.Shifter.SetModifier(ShifterModifier.DNS);
                        _cpu.Shifter.DNSCarry = carry;
            ...
            protected override void ExecuteSpecialFunction2Late(MicroInstruction instruction)
            {
                ...
                switch (ef2)
                {
                    case EmulatorF2.LoadDNS:
                        ...
                        //
                        ushort result = _cpu.Shifter.Output;
                        int carry = _cpu.Shifter.DNSCarry;
                        switch (_cpu._ir & 0x7)
                        {
                            case 0:
                                // None, SKIP is reset
